...
// Reads a guess from the user and returns it as a number.
function readGuess(reader) {
  ...
  return new Promise((resolve) => {
    ...
    const ask = () => {
      ...
      reader.question("Your guess: ", (input) => {
        // Convert the input string into a number
        const guess = Number.parseInt(input.trim(), 10);
